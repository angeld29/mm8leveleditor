/*
 *  com/mmbreakfast/unlod/lod/InvalidLodFileException.java
 *
...
public class InvalidLodFileException extends Exception {
   public InvalidLodFileException(String message) {
      super(message);
   }
}