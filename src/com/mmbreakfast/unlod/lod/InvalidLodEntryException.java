/*
 *  com/mmbreakfast/unlod/lod/InvalidLodEntryException.java
 *
...
public class InvalidLodEntryException extends Exception {
   public InvalidLodEntryException(String message) {
      super(message);
   }
}