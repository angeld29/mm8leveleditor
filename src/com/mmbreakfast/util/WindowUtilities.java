/*
 *  com/mmbreakfast/util/WindowUtilities.java
 *
...
public class WindowUtilities {
   ...
   private WindowUtilities() {} //Defeat instantiation

	public static final void centerOnScreen(Window win) {
	   Dimension d   = win.getSize();
      Dimension scr = Toolkit.getDefaultToolkit().getScreenSize();
	   int width     = d.width;
	   int height    = d.height;
	   win.setBounds((scr.width - width) / 2, (scr.height - height) / 2, width, height);
	}
}